...
BPF_CALL_1(bpf_prefetch_1, void *, ptr__ign)
{
	return 0;
}

static const struct bpf_func_proto bpf_prefetch_1_proto = {
	.func		= bpf_prefetch_1,
	.gpl_only	= false,
	.ret_type	= RET_INTEGER,
	.arg1_type	= ARG_ANYTHING,
...
BPF_CALL_1(bpf_prefetch_w, void *, ptr__ign)
{
	return 0;
}

static const struct bpf_func_proto bpf_prefetch_w_proto = {
	.func		= bpf_prefetch_w,
	.gpl_only	= false,
	.ret_type	= RET_INTEGER,
	.arg1_type	= ARG_ANYTHING,
